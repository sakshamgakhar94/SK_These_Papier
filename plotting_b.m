...
legend('d/L_p\rightarrow 0 limit','d/L_p\rightarrow \infty limit',['w/L_c = ' num2str(w_by_Lc(1))],...
    ['w/L_c = ' num2str(w_by_Lc(2))],['w/L_c = ' num2str(w_by_Lc(3))],'Location','southwest','FontSize',9,'FontWeight','bold');
