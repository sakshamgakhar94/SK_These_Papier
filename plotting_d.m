...
unevenness{1} = [0.161345868 0.359109154 0.565205658 0.372173637];
...
p=1;
for p=1:1:3
plot(d_by_Lp{p},log(R_sim{p}),plotStyle{p+2},'LineWidth',1.2);
end
w_by_Lc = w./Lc;

legend(['w/L_c = ' num2str(w_by_Lc(1))],['w/L_c = ' num2str(w_by_Lc(2))],['w/L_c = ' num2str(w_by_Lc(3))],...
    'Location','southeast','FontSize',9,'FontWeight','bold');
